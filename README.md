...
__What happens (in packet_parser.cpp):__
...
__What happens (in sni_extractor.cpp):__
...
The multi-threaded version (`dpi_mt.cpp`) adds __parallelism__ for high performance:
